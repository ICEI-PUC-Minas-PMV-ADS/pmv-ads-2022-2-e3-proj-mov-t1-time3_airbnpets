...
export default function Welcome({ navigation }) {
    return (
        ...
        <View style={styles.container}>
            <Header />
            <ImageBackground style={styles.image} source={require('../../assets/pet-hotel-des.jpg')} />
            <Text>
                <TouchableOpacity style={styles.buttonRota} onPress={() => navigation.navigate("Pesquisa")}>
